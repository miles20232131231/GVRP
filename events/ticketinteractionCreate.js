...
module.exports = {
    ...
    async execute(interaction) {
        const logChannelId = '1268998427644002305'; // Log channel ID
        ...
        try {
            if (interaction.isStringSelectMenu()) {
                ...
                if (interaction.customId === 'ticket_select') {
                    ...
                    const generalStaffRoleId = '1268918890314993736'; 
                    const staffReportRoleId = '1268917961419132990'; 
                    ...
                    const categoryID = '1268920898342096938'; 
                ...
                if (interaction.customId === 'claim_ticket') {
                    const staffRoleId = '1268918890314993736'; 
                    const staffReportRoleId = '1268917961419132990'; 
